...
install.packages(c("fastmap", "colorspace", "sys", "bit", "ps", "digest", "cachem", "farver", "askpass", "bit64", "evaluate", "highr", "xfun", "yaml", "bslib", "tinytex", "backports", "glue", "DBI", "withr", "data.table", "gtable", "uuid", "curl", "cpp11", "openssl", "systemfonts", "textshaping", "crayon", "fs", "knitr", "rmarkdown", "stringi", "broom", "cli", "jsonlite", "ragg", "reprex", "rlang", "rstudioapi"), type = "source")
...
# Criando o box plot (Podendo ser utilizado no PowerBI)
